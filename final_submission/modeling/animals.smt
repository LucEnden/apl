...
; Some more notes:
; - after changing the order in which I check how many we bought (+ Nd Nc Nm) and enforce we need to buy each animals once, the model changes but remains satisfiable